...
#import "BELLMoatAdEvent.h"

@interface BELLMoatVideoTracker : BELLMoatBootstrap

+ (BELLMoatVideoTracker *)trackerWithPartnerCode:(NSString *)partnerCode;
...
- (void) dispatchEvent:(BELLMoatAdEvent *)event;
